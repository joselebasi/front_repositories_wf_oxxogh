...
import RepositoryClosedPullRequest from './RepositoryClosedPullRequest';
...
import RepositoryTopicsActivity from './RepositoryTopicsActivity';
        ...
        <div className="w-full space-y-6">
            ...
            <div className="flex justify-center">
                <div className="inline-flex p-1 bg-gray-100 dark:bg-[#404040] rounded-xl shadow-inner border border-gray-200 dark:border-gray-700">
                    ...
                    <button
                        onClick={() => setActiveTab('prs-closed')}
                        className={`flex items-center gap-2 px-6 py-2.5 text-sm font-bold rounded-lg transition-all duration-300 ${
                            activeTab === 'prs-closed'
                                ? 'bg-white dark:bg-[#303030] text-amber-600 dark:text-amber-400 shadow-md transform scale-105'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-white/50 dark:hover:bg-white/5'
                        }`}
                    >
                    ...
                    >
                        <svg width="20px" height="20px" viewBox="0 0 448 448" fill="currentColor">
                            <path d="M96 96v69.451l29.951-29.951c10-9.999 26.1-9.999 36.1 0l150.45 150.45c10 10 10 26.1 0 36.1L282.55 352H448V96h-96v48H192V96H96z" />
                            <rect width="352" height="64" x="96" y="0" />
                            <path d="M282.57 291.17L156.83 165.43c-7.24-7.24-18.98-7.24-26.23 0l-26.11 26.12 33.12 33.12c7.7-2.6 16.52-.86 22.66 5.28 6.17 6.17 7.9 15.08 5.23 22.8l31.93 31.92c7.73-2.66 16.63-.94 22.8 5.24 8.62 8.62 8.62 22.59 0 31.21-8.63 8.62-22.59 8.62-31.22 0-6.48-6.49-8.09-16.02-4.8-24l-29.78-29.77v78.35c2.1 1.04 4.08 2.42 5.83 4.17 8.62 8.62 8.62 22.59 0 31.22-8.62 8.61-22.59 8.61-31.21 0-8.62-8.63-8.62-22.6 0-31.22 2.13-2.13 4.6-3.74 7.23-4.82v-79.08c-2.63-1.08-5.09-2.67-7.23-4.82-6.53-6.53-8.1-16.11-4.75-24.13L91.66 204.37 5.43 290.59c-7.24 7.25-7.24 19 0 26.24l125.75 125.74c7.24 7.24 18.98 7.24 26.23 0L282.57 317.41c7.24-7.25 7.24-19 0-26.24z" />
                        </svg>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                {activeTab === 'branches' ? (
                    ...
                    <RepositoryClosedPullRequest />
                ) : activeTab === 'thresholds' ? (
                    <RepositoryThresholdLastUpdate />
                ) : activeTab === 'topics' ? (
                    <RepositoryTopicsActivity />
                ) : (
